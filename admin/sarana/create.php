...
if(isset($_POST['simpan'])){
    ...
    $sql = "INSERT INTO jenis_sarana VALUES ('', '$nama')";
    mysqli_query($conn, $sql);
    $_SESSION['alert'] = "Jenis sarana baru berhasil ditambahkan";
...
<head>
    ...
    <title>Create - Jenis sarana</title>
</head>
<body>
<?php
include('../sidebar.php');
                        ...
                        <div class="row">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="mb-3">
                                    ...
                                    <input name="nama_jenis" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Nama Jenis" required>
                                </div>
