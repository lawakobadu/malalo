...
if (isset($_POST['simpan'])) 
{
	...
	if($_FILES['foto']['error'] === TRUE){
		...
		if(!in_array($imageExtension, $validImageExtension)){
			...
			$sql = "INSERT INTO users VALUES ('', '$username', '$password', '$name', '$role', '$nip', '$jabatan', '$newImageName')";
			mysqli_query($conn, $sql);
			$_SESSION['alert'] = "Data user berhasil ditambahkan";
			header("Location: /malalo/admin/user/");
		}
	}
}
            ...
            <div class="content p-4">
                <div class="card shadow rounded-4" style="border: none;">
                    <div class="card-body p-5">
                        <div class="row">
                            <div class="float-start mb-4" style="border-bottom: 2px solid rgba(71, 139, 202, 0.6); width: auto;"> <h5 class="fw-700">Form Tambah User</h5></div>
                        </div>
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="password" type="password" class="form-control" id="exampleFormControlInput2" placeholder="Password" required>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlInput2" class="form-label">Nama</label>
                                    <input name="name" type="text" class="form-control" id="exampleFormControlInput2" placeholder="Nama" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="exampleFormControlInput2" class="form-label">NIP</label>
                                    <input name="nip" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" type="text" class="form-control" id="exampleFormControlInput2" placeholder="NIP" required>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlInput2" class="form-label">Jabatan</label>
                                    <input name="jabatan" type="text" class="form-control" id="exampleFormControlInput2" placeholder="Jabatan" required>
                                </div>
                                <div class="mb-3">
