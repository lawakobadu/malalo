...
if (isset($_POST['simpan'])) 
{
	...
	if($_FILES['foto']['error'] === TRUE){
		...
		if(!in_array($imageExtension, $validImageExtension)){
			...
			$sql = "INSERT INTO berita VALUES ('', '$judul', '$tanggal', '$author', '$isi', '$newImageName')";
			mysqli_query($conn, $sql);
			$_SESSION['alert'] = "Berita baru berhasil ditambahkan";
			header("Location: /malalo/admin/berita/");
		}
	}
}
                        ...
                        <div class="row">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="isi" class="form-control" id="floatingTextarea" style="height: 500px" required></textarea>
                                </div>
