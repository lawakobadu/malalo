...
<head>
    ...
    <title>Struktur Organisasi - Nagari Guguk Malalo</title>
</head>
<body>
    <header>
                ...
                <div class="content p-4">
                    <div class="card shadow rounded-4" style="border: none;">
                        <div class="card-body p-5">
                            <h3 class="fw-700">Struktur Organisasi</h3>
                            <div class="text-center mt-5">
                            <img class="img-fluid" src="admin/struktur/upload/<?php echo $data['struktur']; ?>" alt="Struktur Organisasi">
                            </div>
                        </div>
                    </div>
                </div>
